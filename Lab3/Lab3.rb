...
module Rendering
    ...
    class Font
        def check_default
            puts "name: #{DEFAULT_FONT.name} weight: #{DEFAULT_FONT.weight} size: #{DEFAULT_FONT.size}"
        end
    ...
    class PaperSize
        def check_default
            puts "name: #{DEFUALT_PAPER_SIZE.name} weight: #{DEFUALT_PAPER_SIZE.width} size: #{DEFUALT_PAPER_SIZE.height}"
        end
